// Archivo de servicio para Plásticos de Ingeniería.
console.log('Servicio Plásticos de Ingeniería cargado');
// Información adicional asignada a variable:
const serviceInfo = 
`
        <section class="rpt_container_section_second rpt_container_section_second01 rpt_container_section_second_07">
...
element.textContent = serviceInfo;
document.getElementById('serviceContent').appendChild(element);
